...
def change_img(path):
    ...
    name = path
    name_fraze = name[:-30]+"images/193003_" + name[-24:-5]
    #name ="ss.mp4"
    ...
    while(cap.isOpened()):  # 最終フレームまで処理を繰り返す
        ...
        if ret == True:  # 画像がフレーム内のものだったら
            ...
            for cnt in contours:
                ...
                # 輪郭が一番大きい & 大きさが一定値以内
                if max_area < area and area < 300000 and area > 30000:
                    max_area = area;
                    target = cnt
   ...
   #もし外出画像だったら
    ...
    if judge[0]/judge[1] < W/2:
        ...
        if ret:
            ...
            cap.release()
            return name_fraze+".jpg"

    cap.release()
    return False

if __name__=='__main__':
    change_img('/home/pi/SAL_Web-master/media/movie/2020:01:29:15:47:09.h264')
    print("a")
